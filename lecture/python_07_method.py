...
#   - parameter값 2개 이상 사용 시 정의된 순서대로 전달해야함
...
# def test(a, b, c = 3):          # 가능
# def test(a, b = 2, c=3):        # 가능
# def test(a = 1, b = 2, c=3):    # 가능
# def test(a = 1, b, c):          # 불가능
# def test(a, b = 2, c):          # 불가능
# def test(a = 1, b = 2, c):      # 불가능
#   - Default parameter는 오른쪽에서부터 시작

# 5. return
#   - 기본적으로 함수 종료 의미
#   - return 반환값: 함수호출문으로 값 전달(tuple type)
#   - reutrn만 사용하면 함수호출문으로 None값 전달

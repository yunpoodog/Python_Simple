...
# 회사: 항상 신기술, 새로 나온 코드 기법 사용 x(과거 기법, 새로운 기법 모두 공부)
...
# 4) 논리형(boolean): True, False(True, False는 첫글자는 무조건 대문자로)

# 설명: 동일한 Type에서 다양한 종류의 자료형을 사용하는 이유?
# - 메모리(저장공간)를 효율적으로 사용하기 위해서
# - 대부분 만들어진지 오래 된 언어는 다양한 종류의 자료형 사용
# - 자료형은 저장할 수 있는 크기의 범위가 지정
# - 가정: int(-10000 ~ 10000)
# - 가정: short(-100 ~ 100)
# - 특정 값: 0~9 -> 어떤 Type을 사용하면 효율적일까? = short
...
# 문자열 실수형("3.14") -> 정수형(Error) - 유일하게 안됨.
...
num = 4
num = 10
print(num)  # 출력: 10 - 변수는 하나의 값만 저장하기 때문에 아래 있는 10이 출력됨.
...
# 9. 동적 출력
print("=" * 200)
student_num = 20233077
student_name = "윤똥개"
# 출력 예: "조선대학교 20233077, 윤똥개 입니다."
print("조선대학교 20233077, 윤똥개 입니다.")   # 하드 코딩 지양
# 1. format() - Old
